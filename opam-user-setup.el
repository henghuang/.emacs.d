...
;; ## added by OPAM user-setup for emacs / tuareg ## 2a0ccc6e9d2916740c904adaa5aab4ed ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/heng/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
